...
AI assistance (OpenAI Codex) was used to help locate the official practical template, complete and execute the notebook, verify the self-check, and prepare the required archive. The student is responsible for understanding, explaining, and modifying every submitted file.
